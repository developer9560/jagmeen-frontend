        ...
        <main className="bg-white min-h-screen">
            <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8 lg:px-12 text-center">
                ...
                <div className="prose prose-gray max-w-none prose-headings:font-semibold prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-8 prose-li:text-gray-700">
                    ...
                    <h2 className="font-bold text-2xl p-4">OVERVIEW</h2>

                    <p className="text-justify">
                        Thank you for visiting Jagmeen. This website is operated by Jagmeen
                        Fashion. Throughout the site, the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer
                        to Jagmeen Fashion. Jagmeen Fashion offers this website, including all
                        information, tools and services available from this site to you, the
                        user, conditional upon your acceptance of all terms, conditions,
                        policies and notices stated here.
                    
                        By visiting our site and/or purchasing something from us, you engage
                        in our &ldquo;Service&rdquo; and agree to be bound by the following terms and
                        conditions (&ldquo;Terms of Service&rdquo;, &ldquo;Terms&rdquo;), including those additional
                        ...
                        Our store is hosted on Hostinger lnc. They provide us with the online
                        e-commerce platform that allows us to sell our products and services to
                        you.
                    </p>

                    <h2 className="font-bold text-2xl p-4">SECTION 1 - ONLINE STORE TERMS</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 2 - GENERAL CONDITIONS</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 7 - OPTIONAL TOOLS</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4"  >SECTION 8 - THIRD-PARTY LINKS</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 10 - PERSONAL INFORMATION</h2>

                    <p className="text-justify">
                        Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy.
                    </p>

                    <h2 className="font-bold text-2xl p-4">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 12 - PROHIBITED USES</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 15 - SEVERABILITY</h2>

                    <p className="text-justify">
                        In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.
                    </p>

                    <h2 className="font-bold text-2xl p-4">SECTION 16 - TERMINATION</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 18 - GOVERNING LAW</h2>

                    <p className="text-justify">
                        These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of Sector 29 Bypass Near Kheri Pull chowk, Faridabad, Haryana 121002.
                    </p>

                    <h2 className="font-bold text-2xl p-4">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
                    ...
                    <h2 className="font-bold text-2xl p-4">SECTION 20 - CONTACT INFORMATION</h2>

                    <p className="text-justify">
                        Questions about the Terms of Service should be sent to us at jagmeensupportteam@gmail.com
                    </p>
