...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${SITE_URL}/trending`, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${SITE_URL}/best-sellers`, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${SITE_URL}/category`, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${SITE_URL}/men`, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${SITE_URL}/women`, changeFrequency: 'weekly', priority: 0.9},
