            ...
            <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8 lg:px-12 text-center">
                ...
                <div className="prose prose-gray max-w-none prose-headings:font-semibold prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-8 prose-li:text-gray-700">
                    ...
                    <p className="text-justify">
                        ...
                        address and telephone numbers. We will also ask for your chosen
                        method of payment (credit card or online payment service). Your
                        payment information is securely transferred to a third party vendor
                        for processing. We do not retain credit card or other payment
                        identification information on our servers or elsewhere. Email Ids
                        are used to let you know about our latest arrivals and exclusive
                        offers.
                    </p>
                    ...
                    <p className="text-justify">
                        ...
                        Email marketing: With your permission, we may send you emails about
                    ...
                    <p className="text-justify">
                        ...
                        processing and use of personal information by us for the purpose of
                        administering and dealing with your order or account, market
                        research, processing your payments, credit reference checking and
                        fraud detection, and for marketing purposes as outlined above. Any
                        changes to our privacy policy will be posted on this site so that you
                        may ensure that you are fully informed of your rights and can notify
                    ...
                    <p className="text-justify">
                        ...
                        used only to determine your browser and user preferences for our
                        site. We believe that this can greatly assist us in providing you
                        with the service that you desire and to enhance your browsing
                        experience. However, if you prefer, your browser software should
                        enable you not to accept cookies. You should still be able to use our
                    ...
                    <p className="text-justify">
                        ...
                        more information contact at jagmeensupportteam@gmail.com
                    </p>
