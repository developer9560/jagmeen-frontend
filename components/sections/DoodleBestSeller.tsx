    ...
    <section className="bg-white py-6 md:py-8">
      <div className="max-full mx-auto px-4 md:px-8">
        ...
        <div className="flex justify-center h-30 w-full ">
          ...
          <Link href="/best-sellers" className="text-sm font-bold uppercase tracking-wider text-primary hover:text-red-500 transition-colors flex  justify-center items-center  group h-10 w-30   mt-6 md:mt-0 gap-2">
            View All
